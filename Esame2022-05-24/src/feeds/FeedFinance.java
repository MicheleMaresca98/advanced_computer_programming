...
public class FeedFinance {
	...
	public static void main(String[] args) {
		...
		try {
			...
			TopicSubscriber subscriber = tsession.createSubscriber(finance);
			FinanceListener listener = new FinanceListener();
			subscriber.setMessageListener(listener);
			System.out.println("[FeedFinance]: avviato");
